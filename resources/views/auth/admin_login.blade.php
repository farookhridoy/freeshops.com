...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Admin Login - FreeShopps </title>
                            ...
                            <div class="card-body">
                                <div class="px-3">
                                    <div class="auth-logo-box">
                                        <a href="{{ route('home') }}" class="logo logo-admin"><img src="{{ asset('admin/assets/images/logo-sm.png') }}" height="55" alt="logo" class="auth-logo"></a>
                                    </div><!--end auth-logo-box-->

                                    <div class="text-center auth-logo-text">
                                        <h4 class="mt-0 mb-3 mt-5">Admin FreeShopps</h4>
                                        <p class="text-muted mb-0">Sign in to continue to FreeShopps.</p>
                                    ...
                                    <form class="form-horizontal auth-form my-4" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Enter email" autocomplete="email">
                                                @error('email')
