        ...
        <div class="row align-items-center">
            <div class="col-sm-12">
                <div class="text-center">
                    <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> FreeShopps. Developed with <i class="fa fa-heart text-danger"></i> by <a href="https://thelarasoft.com" target="_blank" class="text-reset">LaraSoft</a>.</p>
                </div>
            </div><!--end col-->
        </div><!--end row-->
    </div><!--end container-->
